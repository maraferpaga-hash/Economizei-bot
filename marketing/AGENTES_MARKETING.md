...
**Saída:** 5 ideias de hook prontas para virar vídeo, salvas em `E:\Economizei Bot\marketing\tendencias\YYYY-MM-DD.md`.
...
**Saída:** 2 roteiros completos (gancho + corpo + CTA + sugestão de B-roll/voz off) em `E:\Economizei Bot\marketing\roteiros\`.
...
**Insumos:** nada.
**Saída:** planilha CSV em `E:\Economizei Bot\marketing\prospeccao\semana-NN.csv` com:
...
**Saída:** relatório de 1 página em `E:\Economizei Bot\marketing\relatorios\YYYY-WW.md` com:
...
**Saída:** triage em `E:\Economizei Bot\marketing\inbox\YYYY-MM-DD.md`:
