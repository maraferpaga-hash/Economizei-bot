...
1. **Ler** `E:\Economizei Bot\CLAUDE.md` (memória institucional — fonte da verdade).
2. **Ler** `E:\Economizei Bot\.claude\skills\README.md` (índice das 14 skills + 10 regras de ouro).
3. **Identificar** em qual área da empresa o Gabriel quer trabalhar nesta sessão.
4. **Carregar mentalmente** as skills correspondentes a essa área (lista de gatilhos abaixo).
...
2. Atualizar "Última atualização" no topo do CLAUDE.md.
3. Confirmar ao Gabriel em 2 linhas o que foi alterado.
...
| Caminho | Função |
|---|---|
| `E:\Economizei Bot\CLAUDE.md` | Memória institucional (sempre ler primeiro). |
| `E:\Economizei Bot\.claude\skills\README.md` | Índice das 14 skills + 10 regras de ouro. |
